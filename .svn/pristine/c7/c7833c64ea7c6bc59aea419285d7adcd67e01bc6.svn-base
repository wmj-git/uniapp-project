	...
	<view>
		...
		<view class="">
			...
			<view class="infor">
				...
				<!-- //申请提现 -->
				<view class="appl_pay" @tap="distribuTap" :class="[extendShow ? 'show' : 'hide' ]">
					申请提现				
				</view>
		...
		<view class="uni-list mart20">
			...
			<!-- 如果是分销员 -->
			<view class="uni-list-item" :class="[extendShow ? 'show' : 'hide' ]">
		...
		<view class="uni-padding-wrap center">			
			<image class="img100" mode="widthFix" :src="advertPic"></image>
		</view>
...
<script>
	...
	                   
			...
			async advertpicAPI() {
				...
				console.log(res);
				this.advertPic = res.data.data.value
